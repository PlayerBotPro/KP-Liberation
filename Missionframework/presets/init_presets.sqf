...
switch (KP_liberation_preset_blufor) do {
    ...
    case 31: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\bot_bwmod.sqf";};
...
switch (KP_liberation_preset_opfor) do {
    ...
    case 21: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\bot_3cb_baf.sqf";};
